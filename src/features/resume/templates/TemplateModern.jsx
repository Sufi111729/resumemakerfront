export function TemplateModern({ data }) {
  ...
  return (
    <div className="space-y-4 text-sm">
      <div>
        <div className="text-xl font-semibold">{personal.fullName || "Your Name"}</div>
        <div className="text-ink/60">{personal.title || "Role"}</div>
        <div className="text-ink/50">{personal.email || "email@example.com"}</div>
      </div>
      <section>
        <div className="text-xs uppercase tracking-widest text-ink/40">Summary</div>
        <p className="mt-1 text-ink/70">{summary || "Short professional summary."}</p>
      </section>
      <section>
        <div className="text-xs uppercase tracking-widest text-ink/40">Experience</div>
      ...
      <section>
        <div className="text-xs uppercase tracking-widest text-ink/40">Education</div>
        <div className="mt-2 space-y-2">
          {education.map((edu) => (
            <div key={edu.id}>
      ...
      <section>
        <div className="text-xs uppercase tracking-widest text-ink/40">Projects</div>
        <div className="mt-2 space-y-2">
          {projects.map((proj) => (
            <div key={proj.id}>
      ...
      <section>
        <div className="text-xs uppercase tracking-widest text-ink/40">Skills</div>
